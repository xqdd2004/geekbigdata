package com.dd.spark.distcp2

import java.net.URI

import com.dd.spark.distcp2.objects._
import com.dd.spark.distcp2.utils.{CopyUtils, FileListUtils, PathUtils}
...
object SparkDistCP extends Logging {
  ...
  /**
    ...
    */
def doCopy(sourceRDD: RDD[CopyDefinitionWithDependencies], accumulators: Accumulators, options: SparkDistCPOptions): RDD[DistCPResult] = {
  ...
  /**
    ...
    */
  private def doDelete(destRDD: RDD[URI], accumulators: Accumulators, options: SparkDistCPOptions): RDD[DistCPResult] = {
  ...
  /**
    ...
    */
  private def batchAndPartitionFiles(rdd: RDD[CopyDefinitionWithDependencies], maxFilesPerTask: Int, maxBytesPerTask: Long): RDD[((Int, Int), CopyDefinitionWithDependencies)] = {
  ...
  /**
    ...
    */
  private def generateBatchedFileKeys(maxFilesPerTask: Int, maxBytesPerTask: Long): (Int, Iterator[CopyDefinitionWithDependencies]) => Iterator[((Int, Int), CopyDefinitionWithDependencies)] = {
    (partition, iterator) =>
